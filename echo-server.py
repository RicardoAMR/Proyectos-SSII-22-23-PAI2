    ...
    with conn:
        ...
        while True:
            ...
            if not data:
                ...
                print(funciones_aux.gen_prueba_random(mensaje))
                ...
                if codificado == mensaje[1]:
                    ...
                    file.write("Día " + str(datetime.now().strftime('%d')) + " a las " + str(datetime.now(
                    ).strftime('%H:%M')) + ": ACIERTO - No se ha alterado ningún mensaje" + os.linesep)
                else:
                    print("Ha habido modificación")
                    file.write("Día " + str(datetime.now().strftime('%d')) + " a las " + str(
